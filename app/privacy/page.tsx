...
export default function PrivacyPage() {
  return <main className="privacy-page">
    <article className="privacy-card">
      ...
      <section><h2>RuneScape lookups</h2><p>When you refresh HiScores or sync quests, the group name and public RuneScape names are sent through Ironpath to the official RuneScape HiScores and RuneMetrics services. Results are cached briefly to improve reliability and reduce requests.</p></section>
